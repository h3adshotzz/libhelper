 ...
 */
//this version states that libhelper is being built on macOS for x86_64 in debug mode.
#define LIBHELPER_VERSION                   "libhelper-3000.123.0.0~0"//###LIBHELPER_VERSION_STRING###
